    ...
    <div class="container">
      <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start"> 
        <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0 navBar">
          ...
          <li><a href="./pages/indumentaria.html" class="nav-link px-2 text-white">Cuentos</a></li>
          <li><a href="./pages/comprando.html" class="nav-link px-2 text-white">Juegos</a></li>
